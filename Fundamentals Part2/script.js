...
if(johnObject.bmi > markObject.bmi){
    console.log(`John Smith's BMI (${johnObject.bmi}) is higher than Mark Miller's (${markObject.bmi})!`);
}
else if(markObject.bmi > johnObject.bmi){
    console.log(`Mark Miller's BMI (${markObject.bmi}) is higher than John Smith's (${johnObject.bmi})!`);
}
